...
namespace EFCoreEnigmaCamp.Migrations
{
    ...
    [Migration("20221114073056_AddFieldLastUpdateInStudent_2")]
    partial class AddFieldLastUpdateInStudent2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreEnigmaCamp.Database.Parents", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParentId = new Guid("5629edd5-719a-49cb-b43a-032479ceb3c9"),
                            Address = "Konoha",
                            ParentName = "Fugaku"
                        },
                        new
                        {
                            ParentId = new Guid("836c90ff-da8f-46a5-abd9-e96b7b2fd329"),
                            Address = "Konoha",
                            ParentName = "Hiashi"
                        });
                });
