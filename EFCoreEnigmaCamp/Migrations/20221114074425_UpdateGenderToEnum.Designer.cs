...
namespace EFCoreEnigmaCamp.Migrations
{
    ...
    [Migration("20221114074425_UpdateGenderToEnum")]
            ...
            modelBuilder.Entity("EFCoreEnigmaCamp.Database.Parents", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParentId = new Guid("606ac010-f8e3-4b13-afbc-3dbfd1cac403"),
                            Address = "Konoha",
                            ParentName = "Fugaku"
                        },
                        new
                        {
                            ParentId = new Guid("667db571-c524-4423-ac8e-3b87079d16f8"),
                            Address = "Konoha",
                            ParentName = "Hiashi"
                        });
                });
