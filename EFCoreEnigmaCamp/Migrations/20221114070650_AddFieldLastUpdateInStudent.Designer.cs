...
namespace EFCoreEnigmaCamp.Migrations
{
    ...
    [Migration("20221114070650_AddFieldLastUpdateInStudent")]
    partial class AddFieldLastUpdateInStudent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreEnigmaCamp.Database.Parents", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParentId = new Guid("84e7e914-519f-4aff-8975-0775bb1e83f8"),
                            Address = "Konoha",
                            ParentName = "Fugaku"
                        },
                        new
                        {
                            ParentId = new Guid("a85fd955-bd04-48d7-af54-d66c0a160288"),
                            Address = "Konoha",
                            ParentName = "Hiashi"
                        });
                });
